...
if(error){
  ...
  <div className="w-full m-auto flex my-4">
    <div className="flex flex-col justify-center items-center m-auto">
      <p className="text-2xl text-slate-600 font-bold p-3">ブログの編集  </p>
      <form onSubmit={handleSubmit}>
        ...
        ></textarea>
        <button
        className="text-slate-600 font-semibold px-4 py-2 shadow-xl bg-slate-200 rounded-lg m-auto hover:bg-slate-100">
          更新
        </button>
        <button onClick={handleDelete}
        className="text-slate-600 ml-2 font-semibold px-4 py-2 shadow-xl bg-red-400 rounded-lg m-auto hover:bg-slate-100">
          削除
        </button>
      </form>
    </div>
